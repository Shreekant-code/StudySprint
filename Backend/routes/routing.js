...
import {
  ...
  Quiz,
  evaluateQuiz,
  getSummaryById, getFlashcardById, getQuizById
...
router.post("/quiz/evaluate", verifyToken, evaluateQuiz);
...
router.get("/summary/:uploadId", verifyToken, getSummaryById);
router.get("/flashcard/:uploadId", verifyToken, getFlashcardById);
router.get("/quiz/:uploadId", verifyToken, getQuizById);
